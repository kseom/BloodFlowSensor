...
%% emf of RBCs
timeVaryingMField1 = (MField2(2:end)-MField2(1:end-1))./(time2(2)-time2(1));
emf2 = -N_turn * timeVaryingMField1 * pi * (r^2);

figure(4)
plot(time2(1:end-1),emf2, 'black');
% xlim([0 4e-4]);
xlabel('Time(s)'); ylabel('Electromotive Force(V)');